...
?>
                                <form class="col-lg-6" name="form1" action="process_departure.php" method="POST" enctype="multipart/form-data">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                                <input class="form-control" type="time" name="time" placeholder="Departure" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input class="form-control" type="text" name="src" placeholder="Destination" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
