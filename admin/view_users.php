<?php
    ...
    $sql="SELECT * FROM passengers WHERE is_delete='0' AND Approved=1 ORDER BY FirstName";
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <td><a href="delete_users.php?id=<?php echo $row['PassengerId']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                            <td><a href="update_users.php?id=<?php echo $row['PassengerId']; ?>" class="btn btn-default"><i class="fa fa-edit"></i></a></td>
                                </tr>
